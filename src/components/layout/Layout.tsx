      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto stadium-bg relative">
          ...
          <div className="pointer-events-none fixed inset-0 overflow-hidden z-0">
            <div className="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-primary/[0.04] blur-[120px] animate-neon-pulse" />
            <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full bg-purple/[0.05] blur-[120px]" />
