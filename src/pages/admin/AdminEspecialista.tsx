...
const KPIS_RETOS = [
  { value: 'acv_plus', label: '💰 Monto', shortLabel: 'Monto', valorLabel: 'Meta en MONTO (ej: 15000000)', valorHint: 'Los asesores deben superar este monto', tipoMetrica: 'ACV', canales: ['VC', 'VN_ALIADOS', 'VN_EMPRESARIOS'] },
