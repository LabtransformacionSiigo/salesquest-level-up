...
BEGIN
  ...
  -- Dedup POR GERENTE: incluye gerente_n en la clave (dedup interno del gerente)
  ...
  -- Dedup POR CÉLULA: SIN gerente_n en la clave (elimina aliases duplicados de la misma célula)
  vgm_dedup_celula AS (
